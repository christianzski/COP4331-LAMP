// addeventlistener("submit") -> used for packaging everything into a json
// post request function for updating anything on the server
// dont worry about the set cookie
